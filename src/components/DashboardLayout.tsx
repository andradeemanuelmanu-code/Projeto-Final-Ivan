...
const DashboardLayout = ({ children }: DashboardLayoutProps) => {
  ...
  const menuItems = [
    ...
    { title: "Custos Variáveis", icon: DollarSign, url: "/custos-por-evento" },
    { title: "Custos Fixos", icon: Receipt, url: "/custos-fixos-mensais" },
    { title: "Equipe", icon: Users, url: "/equipe" },
    { title: "Avaliações", icon: Star, url: "/avaliacoes" },
    { title: "Fiscal", icon: FileText, url: "/gestao-fiscal" },
